...
namespace Packets::Types
{
        ...
        : Content{}
    {
        ...
        _params.emplace_back(Constants::PNAME_DESTINATION_CHANNEL_ADDRESS,
                             data[Constants::PIRMX5_DESTINATION_CHANNEL_ADDRESS_INDEX]);
        _params.emplace_back(Constants::PNAME_DESTINATION_TASK, data[Constants::PIRMX5_DESTINATION_TASK_INDEX]);
        _params.emplace_back(Constants::PNAME_SOURCE_CHANNEL_ADDRESS,
                             data[Constants::PIRMX5_SOURCE_CHANNEL_ADDRESS_INDEX]);
        ...
        _params.emplace_back(Constants::PNAME_AUXILIARY_POINT_ATTRIBUTES,
                             data[Constants::PIRMX5_AUXILIARY_POINT_ATTRIBUTES_INDEX]);
        ...
        _params.emplace_back(Constants::PNAME_INSTANTANEOUS_ACTIVE_STATE,
                             data[Constants::PIRMX5_INSTANTANEOUS_ACTIVE_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_INSTANTANEOUS_FAULT_STATE,
                             data[Constants::PIRMX5_INSTANTANEOUS_FAULT_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_CONFIRMED_ACTIVE_STATE,
                             data[Constants::PIRMX5_CONFIRMED_ACTIVE_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_CONFIRMED_FAULT_STATE,
                             data[Constants::PIRMX5_CONFIRMED_FAULT_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_ACKNOWLEDGED_ACTIVE_STATE,
                             data[Constants::PIRMX5_ACKNOWLEDGED_ACTIVE_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_ACKNOWLEDGED_FAULT_STATE,
                             data[Constants::PIRMX5_ACKNOWLEDGED_FAULT_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_OUTPUT_FORCED_MODE, data[Constants::PIRMX5_OUTPUT_FORCED_MODE_INDEX]);
        _params.emplace_back(Constants::PNAME_OUTPUT_UNFORCED_STATE,
                             data[Constants::PIRMX5_OUTPUT_UNFORCED_STATE_INDEX]);
        ...
        : Content{}
    {
        ...
        _params.emplace_back(Constants::PNAME_DESTINATION_CHANNEL_ADDRESS,
                             data[Constants::PIRMX6_DESTINATION_CHANNEL_ADDRESS_INDEX]);
        _params.emplace_back(Constants::PNAME_DESTINATION_TASK, data[Constants::PIRMX6_DESTINATION_TASK_INDEX]);
        _params.emplace_back(Constants::PNAME_SOURCE_CHANNEL_ADDRESS,
                             data[Constants::PIRMX6_SOURCE_CHANNEL_ADDRESS_INDEX]);
        ...
        _params.emplace_back(Constants::PNAME_AUXILIARY_POINT_ATTRIBUTES,
                             data[Constants::PIRMX6_AUXILIARY_POINT_ATTRIBUTES_INDEX]);
        ...
        _params.emplace_back(Constants::PNAME_INSTANTANEOUS_ACTIVE_STATE,
                             data[Constants::PIRMX6_INSTANTANEOUS_ACTIVE_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_INSTANTANEOUS_FAULT_STATE,
                             data[Constants::PIRMX6_INSTANTANEOUS_FAULT_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_CONFIRMED_ACTIVE_STATE,
                             data[Constants::PIRMX6_CONFIRMED_ACTIVE_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_CONFIRMED_FAULT_STATE,
                             data[Constants::PIRMX6_CONFIRMED_FAULT_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_ACKNOWLEDGED_ACTIVE_STATE,
                             data[Constants::PIRMX6_ACKNOWLEDGED_ACTIVE_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_ACKNOWLEDGED_FAULT_STATE,
                             data[Constants::PIRMX6_ACKNOWLEDGED_FAULT_STATE_INDEX]);
        _params.emplace_back(Constants::PNAME_OUTPUT_FORCED_MODE, data[Constants::PIRMX6_OUTPUT_FORCED_MODE_INDEX]);
        _params.emplace_back(Constants::PNAME_OUTPUT_UNFORCED_STATE,
                             data[Constants::PIRMX6_OUTPUT_UNFORCED_STATE_INDEX]);
